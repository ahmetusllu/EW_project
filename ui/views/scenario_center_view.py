...
class ScenarioCenterView(QWidget):
    ...
    def _build_ui(self):
        ...
        self.btn_duzenle = QPushButton("Düzenle", icon=qta.icon('fa5s.edit'))
    ...
    def _connect_signals(self):
        ...
        self.btn_duzenle.clicked.connect(self._edit_scenario)
    ...
    def _export_scenario(self):
        ...
        self.vm.status_updated.emit("Bu özellik henüz eklenmemiştir.")
    ...
    def _duplicate_scenario(self):
        if self.current_scenario:
            self.vm.duplicate_scenario(self.current_scenario)

    def _edit_scenario(self):
        """ViewModel aracılığıyla düzenleme isteği gönderir."""
        if self.current_scenario:
            self.vm.request_edit_scenario(self.current_scenario)